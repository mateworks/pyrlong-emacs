...
(defcustom doxymacs-external-xml-parser-executable
  "/home/james/bin/doxymacs_parser"
...
(defconst doxymacs-JavaDoc-file-comment-template
 '("/**" > n
   ...
   " * " > n
   " * " p > n
   " * " (doxymacs-doxygen-command-char) "history  " (p "Modify description of this file: ") > n
   " * " > n
   " * " (doxymacs-doxygen-command-char)  (current-time-string) ":  "> n
   " * 		created!" > n
   " * " p > n
   " */" > n)
...
(defconst doxymacs-C++-file-comment-template
 '("///" > n
   ...
   "/// " > n
   "/// " (doxymacs-doxygen-command-char) "History  " (p "Modify description of this file: ") > n
   "///    "(current-time-string) ","(user-full-name) ","  (doxymacs-user-mail-address) > n
   "///       created!" > n
   "/// " p > n
   "///" > n)
